...
export declare const mockClear: (mock: any) => any;
export declare const mockReset: (mock: any) => any;
export declare const mockDeep: <T>(mockImplementation?: DeepPartial<T> | undefined) => MockProxy<T>;
declare const mock: <T>(mockImplementation?: DeepPartial<T>, opts?: MockOpts | undefined) => MockProxy<T>;
